...
python main_train.py --epoch_num 201 --data_name train_set_lcg --core_flag --model SAGE

python main_test.py --epoch_num 200 --data_name train_set_lcg --core_flag --model SAGE --epoch_load 200
