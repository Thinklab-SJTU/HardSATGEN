...
python main_train.py --epoch_num 201 --data_name train_set_fg --core_flag --model EGNN

python main_test.py --epoch_num 200 --data_name train_set_fg --core_flag --model EGNN --epoch_load 200
