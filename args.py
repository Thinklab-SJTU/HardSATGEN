...
def make_args():
    ...
    parser.add_argument('--clause_ratio', dest='clause_ratio', default=1, type=float)
    parser.add_argument('--epoch_num', dest='epoch_num', default=201, type=int)
    parser.add_argument('--epoch_log', dest='epoch_log', default=20, type=int) # test every
    parser.add_argument('--epoch_test', dest='epoch_test', default=0, type=int) # test start from when. Default not doing test.
    parser.add_argument('--epoch_save', dest='epoch_save', default=20, type=int) # save every
    parser.add_argument('--epoch_load', dest='epoch_load', default=200, type=int) # test start from when
    ...
    parser.add_argument('--core_flag', dest='core_flag', action='store_true',
                        help='whether enable core detect')
    parser.add_argument('--scramble_ratio', dest='scramble_ratio', default='3-3-2', type=str) # x-x-x each points to 3 operations
